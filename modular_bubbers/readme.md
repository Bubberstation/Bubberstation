# The modularization handbook - Skyrat style, Bubberstation variant v0.2
...
And then you'll want to establish your core folder that you'll be working out of which is normally your module ID. E.g. `modular_bubbers/modules/shuttle_toggle`
...
- ***Example:*** You're adding a new lavaland mob.
  ...
  First of all you create your modular folder. E.g. `modular_bubbers/modules/lavalandmob`
  ...
  ```byond
    /mob/lavaland/newmob
      icon = 'modular_bubbers/modules/lavalandmob/icons/mob.dmi'
      icon_state = "dead_1"
      sound = 'modular_bubbers/modules/lavalandmob/sounds/boom.ogg'
  ```
...
Example: `code/modules/mob/living/living.dm` -> `modular_bubbers/master_files/code/modules/mob/living/living.dm`
...
In short, most of the modular code will be placed in the subfolders of your main module folder **`modular_bubbers/modules/yourmodule/code/`**, with similar rules as with the assets. Do not mirror core code folder structures inside your modular folder.

For example, `modular_bubbers/modules/xenoarcheaology/code` containing all the code, tools, items and machinery related to it.
...
- **Addition:**
  ...
  ```byond
  //BUBBERS EDIT ADDITION BEGIN - SHUTTLE_TOGGLE - (Optional Reason/comment)
...
- **Removal:**
  ...
  ```byond
  //BUBBERS EDIT REMOVAL BEGIN - SHUTTLE_TOGGLE - (Optional Reason/comment)
  /*
  for(var/obj/docking_port/stationary/S in stationary)
    if(S.id = id)
      return S
  */
  //BUBBERS EDIT REMOVAL END
  ...
  ```byond
  //BUBBERS EDIT REMOVAL BEGIN - SHUTTLE_TOGGLE - (Moved to modular_bubbers/shuttle_toggle/randomverbs.dm)
  /*
...
- **Change:**
  ...
  ```byond
  //BUBBERS EDIT CHANGE BEGIN - SHUTTLE_TOGGLE - (Optional Reason/comment)
  //if(SHUTTLE_STRANDED, SHUTTLE_ESCAPE) - BUBBERS EDIT - ORIGINAL
  if(SHUTTLE_STRANDED, SHUTTLE_ESCAPE, SHUTTLE_DISABLED)
  //BUBBERS EDIT CHANGE END
      return 1
  ```
...
That folder is **`code/__DEFINES/~bubbers_defines`**, in which you can add them to the existing files, or create those files as necessary.
...
- Good: /modular_bubbers/modules/example_module/code/disease_mob.dm
- Bad: /modular_bubbers/modules/example_module/code/modules/antagonists/disease/disease_mob.dm

**Icons**: Any .DMI files must go in here.

- Good: /modular_bubbers/modules/example_module/icons/mining_righthand.dmi
- Bad: /modular_bubbers/modules/example_module/icons/mob/inhands/equipment/mining_righthand.dmi
