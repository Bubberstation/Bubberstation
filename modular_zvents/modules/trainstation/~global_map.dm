...
#undef MAP_CENTER_X
#undef MAP_CENTER_Y
#undef MAP_MIN_RADIUS
#undef MAP_MAX_RADIUS
#undef REGION_Y_STEP
#undef CENTER_Y_OFFSET_MIN
#undef CENTER_Y_OFFSET_MAX
#undef INITIAL_BRANCH_OFFSET_MIN
#undef INITIAL_BRANCH_OFFSET_MAX
#undef BRANCH_STEP_Y_MIN
#undef BRANCH_STEP_Y_MAX
#undef OVERLAP_MIN_DISTANCE
#undef NEAR_STATION_CHECK_DIST
#undef NEAR_STATION_SIDE_THRESHOLD
