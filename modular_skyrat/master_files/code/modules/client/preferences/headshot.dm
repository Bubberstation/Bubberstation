...
/datum/preference/text/headshot
	...
	var/static/link_regex = regex("i.gyazo.com|media.discordapp.net|cdn.discordapp.com|a.l3n.co|b.l3n.co|c.l3n.co|static.f-list.net/images/") //BUBBER EDIT: adds F-list's image host to the valid list
...
/datum/preference/text/headshot/is_valid(value)
	...
	if(find_index != 9)
		to_chat(usr, span_warning("The image must be hosted on one of the following sites: 'Gyazo, Discord, Lensdump, F-List'"))
		return
