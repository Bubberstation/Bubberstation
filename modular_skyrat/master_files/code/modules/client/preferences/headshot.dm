...
/datum/preference/text/headshot
	...
	var/static/link_regex = regex("i.gyazo.com|media.discordapp.net|cdn.discordapp.com|static.f-list.net/images/") //BUBBER EDIT: adds F-list's image host to the valid list
