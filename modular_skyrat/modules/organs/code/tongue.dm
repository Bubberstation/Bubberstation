...
/obj/item/organ/tongue/mouse/modify_speech(datum/source, list/speech_args)
	...
	if(findtext(message, "better"))
		speech_args[SPEECH_MESSAGE] = replacetext(message, "better", "cheddar")
	if(findtext(message, "good"))
		speech_args[SPEECH_MESSAGE] = replacetext(message, "good", "gouda")
	if(findtext(message, "be"))
		speech_args[SPEECH_MESSAGE] = replacetext(message, "be", "brie")
	if(findtext(message, "please"))
		speech_args[SPEECH_MESSAGE] = replacetext(message, "please", "cheese")
	if(findtext(message, "permission"))
		speech_args[SPEECH_MESSAGE] = replacetext(message, "permission", "parmession")
	if(findtext(message, "nice"))
		speech_args[SPEECH_MESSAGE] = replacetext(message, "nice", "mice")
	if(findtext(message, "great"))
		speech_args[SPEECH_MESSAGE] = replacetext(message, "great", "grate")
	if(findtext(message, "easy"))
		speech_args[SPEECH_MESSAGE] = replacetext(message, "easy", "cheesy")
	if(findtext(message, "monster"))
		speech_args[SPEECH_MESSAGE] = replacetext(message, "monster", "munster")
	if(findtext(message, "speak"))
		speech_args[SPEECH_MESSAGE] = replacetext(message, "speak", "squeak")
	if(findtext(message, "apologies"))
		speech_args[SPEECH_MESSAGE] = replacetext(message, "apologies", "apolo-cheese")
	if(findtext(message, "vice"))
		speech_args[SPEECH_MESSAGE] = replacetext(message, "vice", "mice")
	if(findtext(message, "blue"))
