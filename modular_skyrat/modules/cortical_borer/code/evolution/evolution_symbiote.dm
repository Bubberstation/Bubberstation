...
/datum/borer_evolution/symbiote/chem_per_level
	...
	tier = 1
	evo_cost = 1
	unlocked_evolutions = list(/datum/borer_evolution/symbiote/harm_decrease)
...
/datum/borer_evolution/symbiote/harm_decrease
	...
	tier = 2
	evo_cost = 2
	unlocked_evolutions = list(/datum/borer_evolution/symbiote/willing_host)
...
/datum/borer_evolution/symbiote/willing_host
	...
	unlocked_evolutions = list(/datum/borer_evolution/symbiote/chem_per_level/t2)
	evo_cost = 3
...
/datum/borer_evolution/symbiote/harm_decrease/t3
	...
	desc = "Further decrease the passive and active damage you do to your host, and how often it occurs."
	tier = -1
	unlocked_evolutions = list(/datum/borer_evolution/symbiote/revive_host)
