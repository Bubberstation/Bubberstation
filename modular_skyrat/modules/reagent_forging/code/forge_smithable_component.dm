...
/datum/component/forge_smithable/proc/good_hit(amount = 1, playsound = FALSE)
	...
	if(playsound)
		playsound(parent_item, 'sound/items/weapons/parry.ogg', vary = TRUE, frequency = 1.2, extrarange = MEDIUM_RANGE_SOUND_EXTRARANGE, ignore_walls = FALSE, volume_preference = /datum/preference/numeric/volume/sound_ambience_volume)

/datum/component/forge_smithable/proc/perfect_hit(amount = 1, playsound = FALSE)
	good_hit(amount, FALSE)
	if(playsound)
		playsound(parent_item, 'sound/items/weapons/parry.ogg', vary = TRUE, frequency = 1.0, extrarange = MEDIUM_RANGE_SOUND_EXTRARANGE, ignore_walls = FALSE, volume_preference = /datum/preference/numeric/volume/sound_ambience_volume)
