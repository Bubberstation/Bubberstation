...
#define REAGENT_INJECT_ARMOR_FAILURE_PERCENT 0.5
#define REAGENT_INJECT_CLOTHING_FAILURE_PERCENT 0.3
#define REAGENT_INJECT_WEAPON_FAILURE_PERCENT 0.5
#define REAGENT_INTEGRITY_DAMAGE_ARMOR_AMOUNT 0.2
#define REAGENT_INTEGRITY_DAMAGE_CLOTHING_AMOUNT 0.1
#define REAGENT_INTEGRITY_DAMAGE_WEARABLE_RANDOM 0.1
