...
/datum/antagonist/ert/nri/greet()
	...
	missiondesc += "<BR> <B>5.</B> Protect, ensure, and uphold the rights of Pan-Slavic Commonwealth's, Kingdom of Agurkrral's and Free Teshari League's citizens on board [station_name()]. SolFed citizens' wellbeing is up to your discretion."
