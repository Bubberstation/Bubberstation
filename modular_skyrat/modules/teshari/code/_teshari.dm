...
/datum/species/teshari/get_species_lore()
	return list(
		...
		They generally are between 3'5 and 4'0 tall, baring raptor-like bodies with large plumes of feathers, and vestigial wings. \
		...
		"Sirisai (or Penelope 3a) is a tropical rainworld with temperatures ranging from 20 to 30 celsius on average. \
		It has three notable mountain ranges, the only places on the planet where snow can be seen year-round. Temperatures can go as low as 15 below. \
		The planet itself is generally very biologically diverse owing to a low amount of conflict within the Teshari species.",
		...
		and were made extinct by the destruction of their entire planet. Fossils have been uncovered, and while they have yet to be named, \
