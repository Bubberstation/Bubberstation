...
/datum/design/organic_printer_suture
	name = "Suture"
	id = "organic_suture"
	build_type = BIOGENERATOR
...
/datum/design/organic_printer_regenerative_mesh
...
/datum/design/organic_printer_medical_gauze
	name = "Medical Gauze"
...
/datum/design/organic_printer_bone_gel
	...
	id = "organic_bone_gel"
	build_type = BIOGENERATOR
	materials = list(/datum/material/biomass = 25) // 6 per stacks
...
/datum/design/organic_printer_surgical_tape
	...
	build_type = BIOGENERATOR
	materials = list(/datum/material/biomass = 25) // 5 per stacks
