...
/datum/area_spawn
	...
	var/list/blacklisted_stations = list("Void Raptor", "Runtime Station", "MultiZ Debug", "Lima Station", "Burgerstation") // BUBBER EDIT - Original: list("Void Raptor", "Runtime Station", "MultiZ Debug")
