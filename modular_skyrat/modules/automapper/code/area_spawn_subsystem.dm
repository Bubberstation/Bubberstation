...
/datum/area_spawn
	...
	var/list/blacklisted_stations = list("Void Raptor", "Runtime Station", "MultiZ Debug", "Gateway Test", "Blueshift", "Biodome", "Moon Station", "Box Station", "RimPoint", "Sigma Octantis")
...
/datum/area_spawn_over
	...
	var/desired_atom
	/// Map blacklist, this is used to determine what maps we should not spawn on.
	var/list/blacklisted_stations = list("Void Raptor", "Runtime Station", "MultiZ Debug", "Gateway Test", "Moon Station", "Box Station", "RimPoint", "Sigma Octantis")
