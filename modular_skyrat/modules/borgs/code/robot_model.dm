...
/obj/item/robot_model/service
	...
	borg_skins = list(
		...
		"NiKO (Alt)" = list(SKIN_ICON_STATE = "sfmekaserv", SKIN_ICON = CYBORG_ICON_MED_TALL, SKIN_FEATURES = list(TRAIT_R_UNIQUEWRECK, TRAIT_R_UNIQUETIP, TRAIT_R_TALL), TALL_HAT_OFFSET),
...
/obj/item/robot_model/engineering
	borg_skins = list(
		...
		"NiKO (Alt)" = list(SKIN_ICON_STATE = "sfmekaengi", SKIN_ICON = CYBORG_ICON_MED_TALL, SKIN_FEATURES = list(TRAIT_R_UNIQUEWRECK, TRAIT_R_UNIQUETIP, TRAIT_R_TALL), TALL_HAT_OFFSET)
	)
...
/obj/item/robot_model/peacekeeper
	borg_skins = list(
		...
		"NiKO (Alt)" = list(SKIN_ICON_STATE = "sfmekapeace", SKIN_ICON = CYBORG_ICON_MED_TALL, SKIN_FEATURES = list(TRAIT_R_UNIQUEWRECK, TRAIT_R_UNIQUETIP, TRAIT_R_TALL), TALL_HAT_OFFSET)
...
/obj/item/robot_model/cargo
	...
	borg_skins = list(
		...
		"NiKO (Alt)" = list(SKIN_ICON_STATE = "sfmekacargo", SKIN_ICON = CYBORG_ICON_MED_TALL, SKIN_FEATURES = list(TRAIT_R_UNIQUEWRECK, TRAIT_R_UNIQUETIP, TRAIT_R_TALL), TALL_HAT_OFFSET),
	)
