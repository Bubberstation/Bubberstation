...
#define DEFAULT_TITLE_SCREEN_IMAGE 'modular_gs/modules/title_screen/icons/gs_title_screen.png' //GS13 - gatofication
#define DEFAULT_TITLE_LOADING_SCREEN 'modular_gs/modules/title_screen/icons/loading_screen.gif' //GS13 - gatofication
