...
/datum/controller/subsystem/title/Initialize()
	var/dat
	if(!fexists("[global.config.directory]/splurt/splurt_title.txt")) // BUBBER EDIT - original title_html.txt
		...
		dat = file2text("[global.config.directory]/splurt/splurt_title.txt") // BUBBER EDIT - original title_html.txt
