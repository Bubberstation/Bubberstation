/datum/species/mammal
	...
	language_prefs_whitelist = list(/datum/language/nekomimetic, /datum/language/carptongue, /datum/language/chimpanzee) //In case you're making a cat anthro or a shark
