...
/datum/sprite_accessory/facial_hair/skyrat/goatee
	name = "Goatee"
	icon_state = "facial_goatee"

/datum/sprite_accessory/facial_hair/skyrat/fiveoclock
	name = "Beard (Five o Clock)"
	icon_state = "facial_5oclock"

/datum/sprite_accessory/facial_hair/skyrat/hornadorns
	name = "Hornadorns"
	icon_state = "facial_hornadorns"

/datum/sprite_accessory/facial_hair/skyrat/chinhorns
	name = "Chin Horns"
