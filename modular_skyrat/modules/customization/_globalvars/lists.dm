...
GLOBAL_LIST_INIT(robotic_styles_list, list(
	...
	"Mariinsky Ballet Company" = 'modular_zubbers/master_files/icons/mob/augmentation/mariinskyipc.dmi' //Bubber Edit - It wouldn't let me make a modular file. I tried. I really tried.
	))
