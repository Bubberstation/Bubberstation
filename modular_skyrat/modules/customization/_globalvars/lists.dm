...
//GLOBAL_LIST_INIT(robotic_styles_list, list(
	...
	//"Morpheus Cyberkinetics" = 'modular_zubbers/master_files/icons/mob/augmentation/mcgipc.dmi',
	//"Bishop Cyberkinetics" = 'modular_zubbers/master_files/icons/mob/augmentation/bshipc.dmi',
	//"Bishop Cyberkinetics 2.0" = 'modular_zubbers/master_files/icons/mob/augmentation/bs2ipc.dmi',
	//"Hephaestus Industries" = 'modular_zubbers/master_files/icons/mob/augmentation/hsiipc.dmi',
	//"Hephaestus Industries 2.0" = 'modular_zubbers/master_files/icons/mob/augmentation/hi2ipc.dmi',
	//"Shellguard Munitions Standard Series" = 'modular_zubbers/master_files/icons/mob/augmentation/sgmipc.dmi',
	//"Ward-Takahashi Manufacturing" = 'modular_zubbers/master_files/icons/mob/augmentation/wtmipc.dmi',
	//"Xion Manufacturing Group" = 'modular_zubbers/master_files/icons/mob/augmentation/xmgipc.dmi',
	//"Xion Manufacturing Group 2.0" = 'modular_zubbers/master_files/icons/mob/augmentation/xm2ipc.dmi',
	//"Zeng-Hu Pharmaceuticals" = 'modular_zubbers/master_files/icons/mob/augmentation/zhpipc.dmi',
	//"Mariinsky Ballet Company" = 'modular_zubbers/master_files/icons/mob/augmentation/mariinskyipc.dmi',
	//))
//BUBBER EDIT END
//ghoul colors
