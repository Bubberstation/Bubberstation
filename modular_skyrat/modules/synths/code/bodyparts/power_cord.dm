...
/obj/item/apc_powercord/afterattack(atom/target, mob/user, proximity_flag, click_parameters)
	...
	if(ipc.nutrition >= NUTRITION_LEVEL_ALMOST_FULL) // BUBBER EDIT - original NUTRITION_LEVEL_WELL_FED
...
/obj/item/apc_powercord/proc/powerdraw_loop(obj/machinery/power/apc/target_apc, mob/living/carbon/human/user)
	...
	while(TRUE)
		var/power_needed = NUTRITION_LEVEL_ALMOST_FULL - user.nutrition // How much charge do we need in total? // BUBBER EDIT - original NUTRITION_LEVEL_WELL_FED - user.nutrition
