...
export type LoadoutList = { loadouts: string[]; loadout: LoadoutListInfo }; // BUBBER EDIT: Multiple loadout presets: ORIGINAL: export type LoadoutList = Record<typePath, LoadoutListInfo>;
