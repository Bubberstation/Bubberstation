...
export const flavor_text: Feature<string> = {
  name: 'Flavor Text',
  description:
    'Appears when examined, provides a visual description with indicators of personality in order to have other characters form their first impression of you. Check the wiki guides for more information.',
