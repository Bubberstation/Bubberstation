...
export type LoadoutList = Record<string, Record<typePath, LoadoutListInfo>>; // BUBBER EDIT: Multiple loadout presets: ORIGINAL: export type LoadoutList = Record<typePath, LoadoutListInfo>;
