...
/datum/hud/human/update_locked_slots()
	...
	if(istype(human_mob))
		...
		if(HAS_TRAIT(human_mob, TRAIT_NO_CLOTHES)) // BUBBER EDIT ADDITION - NO_CLOTHES TRAIT
			blocked_slots |= ITEM_SLOT_ICLOTHING|ITEM_SLOT_OCLOTHING|ITEM_SLOT_ID|ITEM_SLOT_MASK|ITEM_SLOT_NECK|ITEM_SLOT_BACK|ITEM_SLOT_LPOCKET|ITEM_SLOT_RPOCKET|ITEM_SLOT_SUITSTORE // BUBBER EDIT ADDITION - NO_CLOTHES TRAIT
