...
GLOBAL_LIST_INIT(status_display_approved_pictures, list(
	...
	"greenalert",
	"bluealert",
	"violetalert", // BUBBER EDIT ADD - Alert Levels
	"orangealert", // BUBBER EDIT ADD - Alert Levels
	"amberalert", // BUBBER EDIT ADD - Alert Levels
	"redalert",
	"deltaalert",
	"gammaalert", // BUBBER EDIT ADD - Alert Levels
	"radiation",
