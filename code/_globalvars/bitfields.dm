...
DEFINE_BITFIELD(flags_1, list(
	...
	"SUPERMATTER_NOLOGS_1" = SUPERMATTER_NOLOGS_1, //Bubber addition
))
...
#define HIDEFLAGS_BITFIELD list( \
	...
	"SHOWSPRITEEARS" = SHOWSPRITEEARS, \
	"HIDETAIL" = HIDETAIL, \
	"HIDESPINE" = HIDESPINE, \
	"HIDESEXTOY" = HIDESEXTOY, \
	"HIDEFRILLS" = HIDEFRILLS, \
) // SKYRAT EDIT - "SHOWSPRITEEARS" THROUGH "HIDESEXTOY"
//BUBBER ADDITION - HIDEFRILLS
...
DEFINE_BITFIELD(supports_variations_flags, list(
	...
	"CLOTHING_SNOUTED_BETTER_VOX_VARIATION" = CLOTHING_SNOUTED_BETTER_VOX_VARIATION,
	"CLOTHING_SNOUTED_BETTER_VOX_VARIATION_NO_NEW_ICON" = CLOTHING_SNOUTED_BETTER_VOX_VARIATION_NO_NEW_ICON,
	// SKYRAT EDIT END
))
