...
/datum/controller/subsystem/job/proc/setup_officer_positions()
	...
	if(ssc > 0)
		if(J.spawn_positions > 0)
			// SKYRAT EDIT - Reduced from 12 max sec to 7 max sec due to departmental security being deactivated and replaced. //BUBBER EDIT REMOVAL: DEPSEC are useless. Raised to 10 max sec.
