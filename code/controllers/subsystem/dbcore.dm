...
/datum/controller/subsystem/dbcore/Shutdown()
	...
	if(SSdbcore.Connect())
		...
		// BUBBER EDIT START - SQL-based logging
...
/datum/controller/subsystem/dbcore/proc/InitializeRound()
	...
	if(!Connect())
		return
	var/datum/db_query/query_round_initialize = SSdbcore.NewQuery(/* BUBBER EDIT CHANGE - MULTISERVER */
		...
		list("server_name" = CONFIG_GET(string/serversqlname), "internet_address" = world.internet_address || "0", "port" = "[world.port]") // BUBBER EDIT CHANGE - MULTISERVER
	)
