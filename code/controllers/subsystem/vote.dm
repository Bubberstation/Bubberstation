...
/datum/controller/subsystem/vote/proc/submit_multi_vote(mob/voter, their_vote)
	...
	if(current_vote.choices_by_ckey["[voter.ckey]*[their_vote]"] == 1) // BUBBER EDIT CHANGE - Original: [voter.ckey + their_vote]
		current_vote.choices_by_ckey["[voter.ckey]*[their_vote]"] = 0 // BUBBER EDIT CHANGE - Original: [voter.ckey + their_vote]
		current_vote.choices[their_vote]--

	else
		current_vote.choices_by_ckey["[voter.ckey]*[their_vote]"] = 1 // BUBBER EDIT CHANGE - Original: [voter.ckey + their_vote]
		current_vote.choices[their_vote]++
