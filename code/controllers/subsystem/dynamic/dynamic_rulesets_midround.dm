...
/datum/dynamic_ruleset/midround/from_ghosts/paradox_clone/proc/find_original()
	...
	for(var/mob/living/carbon/human/player in GLOB.player_list)
		...
		if(!(player.mind.assigned_role.job_flags & JOB_CREW_MEMBER))
			continue
		// possible_targets += player // BUBBER EDIT REMOVAL - Round Removal OPT-IN
		// BUBBER EDIT ADDITION START - Players in the interlink can't be obsession targets + Round Removal OPT-IN
