...
// BUBBER EDIT CHANGE - was (JOB_UNAVAILABLE_NOHANDS + 1); NOHANDS removed with the job restriction strip
#define JOB_UNAVAILABLE_FLAVOUR_SILICON (JOB_UNAVAILABLE_FLAVOUR + 1)
