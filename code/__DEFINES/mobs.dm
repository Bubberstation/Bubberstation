...
#define TOTAL_LAYERS 48 // SKYRAT EDIT CHANGE - ORIGINAL: 38 // GS13 EDIT original: 44
/// Mutations layer - Tk headglows, cold resistance glow, etc
#define MUTATIONS_LAYER 47 // SKYRAT EDIT CHANGE - ORIGINAL: 37 // GS13 EDIT original: 43
#define BREASTS_BEHIND_LAYER	46		//GS13 Edit - Modular Clothes Layer
/// Mutantrace features (tail when looking south) that must appear behind the body parts
#define BODY_BEHIND_LAYER 45 // SKYRAT EDIT CHANGE - ORIGINAL: 36 // GS13 EDIT original: 42
/// Layer for bodyparts that should appear behind every other bodypart - Mostly, legs when facing WEST or EAST
#define BODYPARTS_LOW_LAYER 44 // SKYRAT EDIT CHANGE - ORIGINAL: 35 // GS13 EDIT original: 41
/// Layer for most bodyparts, appears above BODYPARTS_LOW_LAYER and below BODYPARTS_HIGH_LAYER
#define BODYPARTS_LAYER 43 // SKYRAT EDIT CHANGE - ORIGINAL: 34 // GS13 EDIT original: 40
/// Mutantrace features (snout, body markings) that must appear above the body parts
#define BODY_ADJ_LAYER 42 // SKYRAT EDIT CHANGE - ORIGINAL: 33 // GS13 EDIT original: 39
/// Underwear, undershirts, socks
#define BODY_LAYER 41 // SKYRAT EDIT CHANGE - ORIGINAL: 32 // GS13 EDIT original: 38
/// Eyes and eyelids
#define EYES_LAYER 40 // SKYRAT EDIT CHANGE - ORIGINAL: 31 // GS13 EDIT original: 37
/// Mutations that should appear above body, body_adj and bodyparts layer (e.g. laser eyes)
#define FRONT_MUTATIONS_LAYER 39 // SKYRAT EDIT CHANGE - ORIGINAL: 30 // GS13 EDIT original: 36
/// Damage indicators (cuts and burns)
#define DAMAGE_LAYER 38 // SKYRAT EDIT CHANGE - ORIGINAL: 29 // GS13 EDIT original: 35
// SKYRAT EDIT ADDITION START
/// This layer is used for things that shouldn't be over clothes, but should be over mutations
#define BODY_FRONT_UNDER_CLOTHES 37 // GS13 EDIT original: 34
// SKYRAT EDIT ADDITION END
/// Jumpsuit clothing layer
#define UNIFORM_LAYER 36 // SKYRAT EDIT CHANGE - ORIGINAL: 27  // GS13 EDIT original: 33
// SKYRAT EDIT ADDITION BEGIN - cursed layers under clothing
#define ANUS_LAYER 35 // original: 32
#define VAGINA_LAYER 34 // original: 31
#define PENIS_LAYER 33 // original: 30
#define NIPPLES_LAYER 32 // original: 29
#define BANDAGE_LAYER 31 // original: 28
//SKYRAT EDIT ADDITION END
/// ID card layer
#define ID_LAYER 30 // GS13 EDIT original: 27
/// ID card layer (might be deprecated)
#define ID_CARD_LAYER 29 // GS13 EDIT original: 26
/// Layer for bodyparts that should appear above every other bodypart - Currently only used for hands
#define BODYPARTS_HIGH_LAYER 28 // GS13 EDIT original: 25
/// Gloves layer
#define GLOVES_LAYER 27 // GS13 EDIT original: 24
/// Shoes layer
#define SHOES_LAYER 26 // GS13 EDIT original: 23
/// Layer for masks that are worn below ears and eyes (like Balaclavas) (layers below hair, use flagsinv=HIDEHAIR as needed)
#define LOW_FACEMASK_LAYER 25 // GS13 EDIT original: 22
/// Ears layer (Spessmen have ears? Wow)
#define EARS_LAYER 24 // GS13 EDIT original: 21
/// Layer for neck apperal that should appear below the suit slot (like neckties)
#define LOW_NECK_LAYER 23 // GS13 EDIT original: 20
...
#define MODULAR_BUTT_LAYER		20		//GS13 Edit - Modular Clothes Layer
