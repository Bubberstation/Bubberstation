...
#define EVENT_LOWPOP_THRESHOLD 15 // Bubberstation edit
#define EVENT_MIDPOP_THRESHOLD 30 // Bubberstation edit
#define EVENT_HIGHPOP_THRESHOLD 50 // Bubberstation edit
