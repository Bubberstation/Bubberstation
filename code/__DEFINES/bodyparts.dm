...
#define LIMB_MAX_HP_DEFAULT 60 //Used by most all limbs by default. // BUBBER EDIT CHANGE - ORIGINAL : #define LIMB_MAX_HP_DEFAULT 50
#define LIMB_MAX_HP_ADVANCED 75 //Used by advanced robotic limbs.
#define LIMB_MAX_HP_CORE 250 //Only use this for heads and torsos. // BUBBER EDIT CHANGE - ORIGINAL : #define LIMB_MAX_HP_CORE 200
