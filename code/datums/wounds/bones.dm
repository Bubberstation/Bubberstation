...
/datum/wound/blunt/bone
	...
	wound_flags = (ACCEPTS_GAUZE | SPLINT_OVERLAY) // BUBBER EDIT: MEDICAL -- Makes bone wounds have a splint overlay
...
/datum/wound/blunt/bone/severe
	...
	wound_flags = (ACCEPTS_GAUZE | MANGLES_INTERIOR | SPLINT_OVERLAY) // BUBBER EDIT - MEDICAL (SPLINT_OVERLAY)
