...
/datum/status_effect/grouped/stasis/on_apply()
	...
	if(!.)
		return
	owner.add_traits(list(TRAIT_IMMOBILIZED, TRAIT_HANDS_BLOCKED, TRAIT_STASIS, TRAIT_ANALGESIA), TRAIT_STATUS_EFFECT(id)) // BUBBER EDIT CHANGE - ORIGINAL: owner.add_traits(list(TRAIT_IMMOBILIZED, TRAIT_HANDS_BLOCKED, TRAIT_STASIS), TRAIT_STATUS_EFFECT(id))
	owner.throw_alert("stasis numbed", /atom/movable/screen/alert/numbed) //BUBBER EDIT ADDITION - STASIS APPLIES NUMBED
...
/datum/status_effect/grouped/stasis/tick(seconds_between_ticks)
	update_time_of_death()
	if(owner.stat >= UNCONSCIOUS) //BUBBER EDIT START - STASIS KEEPS SLEEP GOING
		owner.Sleeping(15 SECONDS) //BUBBER EDIT END

/datum/status_effect/grouped/stasis/on_remove()
	owner.remove_traits(list(TRAIT_IMMOBILIZED, TRAIT_HANDS_BLOCKED, TRAIT_STASIS, TRAIT_ANALGESIA), TRAIT_STATUS_EFFECT(id)) // BUBBER EDIT CHANGE - ORIGINAL: owner.remove_traits(list(TRAIT_IMMOBILIZED, TRAIT_HANDS_BLOCKED, TRAIT_STASIS), TRAIT_STATUS_EFFECT(id))
	owner.clear_alert("stasis numbed") //BUBBER EDIT ADDITION - STASIS APPLIED NUMBED
