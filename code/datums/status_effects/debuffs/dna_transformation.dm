...
/datum/status_effect/temporary_transformation/on_apply()
	...
	transforming.visual_only_organs = TRUE // BUBBER EDIT ADDITION - Customization
	new_dna.transfer_identity(transforming)
	transforming.visual_only_organs = initial(transforming.visual_only_organs) // BUBBER EDIT ADDITION - Customization
