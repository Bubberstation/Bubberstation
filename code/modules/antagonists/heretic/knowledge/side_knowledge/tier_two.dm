...
/datum/heretic_knowledge/painting/recipe_snowflake_check(mob/living/user, list/atoms, list/selected_atoms, turf/loc)
	...
	return FALSE
// BUBBER EDIT BEGIN ADDITION - hypnosis ritual early pull (https://github.com/tgstation/tgstation/pull/95796) put here for ease of merging
/datum/heretic_knowledge/hypnosis_ritual
	name = "Unwrap Minds"
	desc = "Exposes a healthen directly to the horrors of the Mansus, hypnotizing them.\
		<br>Further exposure to the horrors of the Mansus may cause the hypnosis to break. Requires a scalpal, a shard of glass, and a living heathen. \
		Whatever is on the paper will be the hypnosis text. Removes mindshields. Has no effect on Heretics."
