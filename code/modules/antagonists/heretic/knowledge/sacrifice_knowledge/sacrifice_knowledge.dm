...
/datum/heretic_knowledge/hunt_and_sacrifice
	...
	var/static/list/grantable_organs = list(
		...
		// /obj/item/organ/eyes/corrupt, BUBBERSTATION EDIT REMOVAL. AWFUL OVERLAY EFFECT THAT PULSATES. JESUS CHRIST.
		/obj/item/organ/heart/corrupt,
		// /obj/item/organ/liver/corrupt, BUBBERSTATION EDIT REMOVAL. SURE LETS OD PEOPLE WHILE THEY'RE BEING TREATED OK.
		// /obj/item/organ/lungs/corrupt, BUBBERSTATION EDIT REMOVAL. HEY REMEMBER ABDUCTORS? HEY REMEMBER WE REMOVED PLASMA GENERATION FROM ABDUCTOR LUNGS? HEY LETS RE-ADD THAT BACK TO HERETIC LUNGS BECAUSE ????
		/obj/item/organ/stomach/corrupt,
		// /obj/item/organ/tongue/corrupt, BUBBERSTATION EDIT REMOVAL. LETS SLUR PEOPLE'S SPEECH AND NOT UNDERSTAND WHY THEY'RE DOING IT BECAUSE WE'RE NOT A GAME BASED ON COMMUNICATION OK.
	)
