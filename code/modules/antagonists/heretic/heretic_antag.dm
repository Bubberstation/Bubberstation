...
/datum/objective/major_sacrifice
	...
	target_amount = 1
	explanation_text = "Sacrifice 1 head of staff, or a fellow Mansus follower." //bubberstation edit - allows heretics to count as heads of staff for objective purposes
