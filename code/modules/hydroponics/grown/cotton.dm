/obj/item/seeds/cotton
	...
	desc = "A pack of seeds that'll grow into a cotton plant." //BUBBER EDIT Original: "A pack of seeds that'll grow into a cotton plant. Assistants make good free labor if neccesary."
