...
/obj/item/multitool/uplink/Initialize(mapload, owner, tc_amount = 35, datum/uplink_handler/uplink_handler_override = null) //BUBBER EDIT CHANGE. Original tc_amount = 20
	. = ..()
...
/obj/item/pen/uplink/Initialize(mapload, owner, tc_amount = 35, datum/uplink_handler/uplink_handler_override = null) //BUBBER EDIT CHANGE. Original tc_amount = 20
	. = ..()
