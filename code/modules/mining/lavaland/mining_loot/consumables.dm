...
/datum/reagent/flightpotion/proc/get_wing_choice(mob/living/carbon/human/needs_wings, obj/item/bodypart/chest/chest)
	...
	for(var/obj/item/organ/wings/functional/possible_type as anything in wing_types)
		...
		accessory = SSaccessories.sprite_accessories[initial(accessory.key)][initial(accessory.name)] //BUBBER EDIT CHANGE - ORIGINAL: accessory = SSaccessories.wings_list[initial(accessory.name)] //get the singleton instance
