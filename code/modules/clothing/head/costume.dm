...
/obj/item/clothing/head/costume/maid_headband
	...
	icon_state = "/obj/item/clothing/head/costume/maid_headband" // BUBBER EDIT - Temporary fix for upstream bug - ORIGINAL: icon_state = "/obj/item/clothing/head/costume/maid"
