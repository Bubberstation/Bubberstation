	...
	if(!isnull(check_holidays(FESTIVE_SEASON)))
		...
		switch(rand(1, 3))
			if(1)
				...
				desc = "A strangely translucent and iridescent crystal. If you stare at it long enough, some say you can hallucinate the distilled essence of the holidays staring back at you."
			if(2)
