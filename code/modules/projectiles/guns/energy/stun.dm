...
/obj/item/gun/energy/e_gun/advtaser
	...
	icon_state = "advtaser"
	ammo_type = list(/obj/item/ammo_casing/energy/electrode/sec, /obj/item/ammo_casing/energy/disabler) //BUBBER EDIT CHANGE - Original: /obj/item/ammo_casing/energy/electrode
	ammo_x_offset = 2
