...
/datum/lighting_object/New(turf/source)
	...
	current_underlay = mutable_appearance('modular_zubbers/icons/turf/walls/wall_lighting.dmi', (source.lighting_uses_jen ? "wall-jen-[source.smoothing_junction]" : "light"), source.z, LIGHTING_PLANE, 255, RESET_COLOR | RESET_ALPHA | RESET_TRANSFORM) // BUBBER EDIT: Toblering: ORIGINAL: current_underlay = new(GLOB.default_lighting_underlays_by_z[source.z])
...
/datum/lighting_object/proc/update()
	...
	if(red_corner.cache_r & green_corner.cache_r & blue_corner.cache_r & alpha_corner.cache_r && \
		...
		current_underlay.icon_state = affected_turf.lighting_uses_jen ? "wall-jen-[affected_turf.smoothing_junction]" : "light" // BUBBER EDIT: Toblering: ORIGINAL: current_underlay.icon_state = null
