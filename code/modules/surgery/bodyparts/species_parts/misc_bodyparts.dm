...
/obj/item/bodypart/head/fly
	...
	is_dimorphic = FALSE
	should_draw_greyscale = FALSE
	head_flags = HEAD_HAIR|HEAD_FACIAL_HAIR|HEAD_EYESPRITES|HEAD_EYEHOLES|HEAD_DEBRAIN // BUBBER EDIT - Flies deserve hair - ORIGINAL: head_flags = HEAD_EYESPRITES|HEAD_EYEHOLES|HEAD_DEBRAIN
	teeth_count = 0
