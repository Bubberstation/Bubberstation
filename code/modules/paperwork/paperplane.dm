/obj/item/paperplane
	...
	// BUBBER EDIT START - Better paper planes
...
/obj/item/paperplane/suicide_act(mob/living/user)
	...
	if(eyes)
		eyes.apply_organ_damage(rand(impact_eye_damage_lower, impact_eye_damage_higher)) // BUBBER EDIT START - Better paper planes
	sleep(1 SECONDS)
	return BRUTELOSS
