...
/mob/living/proc/death(gibbed)
	...
	cut_overlay(GLOB.combat_indicator_overlay) //BUBBER EDIT ADDITION - COMBAT_INDICATOR
	set_combat_indicator(FALSE) //BUBBER EDIT ADDITION - COMBAT_INDICATOR
	set_ssd_indicator(FALSE) //BUBBER EDIT ADDITION - SSD_INDICATOR
