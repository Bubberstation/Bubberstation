...
/mob/living/carbon/human
	...
	hud_possible = list(HEALTH_HUD,STATUS_HUD,BLOOD_HUD,ID_HUD,WANTED_HUD,IMPLOYAL_HUD,IMPSEC_FIRST_HUD,IMPSEC_SECOND_HUD,ANTAG_HUD,GLAND_HUD,FAN_HUD,PERMIT_HUD,DNR_HUD,NEWBIE_HUD)  //BUBBER EDIT ADDITION - PERMIT_HUD, DNR_HUD, NEWBIE HUD
