...
/mob/living/carbon/human
	...
	hud_possible = list(HEALTH_HUD,STATUS_HUD,ID_HUD,WANTED_HUD,IMPLOYAL_HUD,IMPSEC_FIRST_HUD,IMPSEC_SECOND_HUD,ANTAG_HUD,GLAND_HUD,SENTIENT_DISEASE_HUD,FAN_HUD,PERMIT_HUD, DNR_HUD, HEALTH_HUD_NUMBERS) //SKYRAT EDIT ADDITION - PERMIT_HUD, DNR_HUD -- BUBBER ADDITION - HEALTH HUD NUMBERS
