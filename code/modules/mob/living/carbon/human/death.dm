...
/mob/living/carbon/human/death(gibbed)
	...
	if(SSticker.HasRoundStarted())
		...
		log_message("has died with RR [mind?.get_effective_opt_in_level() ? "enabled" : "disabled or unavailable"] (BRUTE: [src.getBruteLoss()], BURN: [src.getFireLoss()], TOX: [src.getToxLoss()], OXY: [src.getOxyLoss()]", LOG_ATTACK) // BUBBER EDIT - Round Removal OPT-IN LOGGING
