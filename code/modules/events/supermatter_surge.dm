...
/datum/round_event/supermatter_surge/announce(fake)
	...
	priority_announce("The Crystal Integrity Monitoring System has detected unusual atmospheric properties in the supermatter chamber, energy output from the supermatter crystal has increased significantly. Engineering intervention is required to stabilize the engine.", "Class [class_to_announce] Supermatter Surge Alert", 'sound/machines/engine_alert/engine_alert3.ogg', sentient = TRUE)
...
/datum/round_event/supermatter_surge/end()
	...
	priority_announce("The supermatter surge has dissipated, crystal output readings have normalized.", "Anomaly Cleared", sentient = TRUE)
	engine = null
	sm_gas = null
