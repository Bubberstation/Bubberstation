...
/datum/unit_test/emoting/Run()
	...
	//BUBBER EDIT REMOVAL BEGIN - Following check does not affect us
	/*
	human.say("*beep")
	...
	*/
	...
	//BUBBER EDIT REMOVAL BEGIN - Following check fails due to global cooldown from the above test step (.8s)
	/*
	human.say("*deathgasp")
