...
/datum/design/board/vendor
	...
	departmental_flags =  DEPARTMENT_BITFLAG_SCIENCE | DEPARTMENT_BITFLAG_CARGO | DEPARTMENT_ENGINEERING | DEPARTMENT_SERVICE // GS13 EDIT un-nerf things Original:	departmental_flags = DEPARTMENT_BITFLAG_SERVICE
