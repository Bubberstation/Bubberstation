...
/obj/effect/spawner/random/aimodule/neutral
	...
	loot = list( // These shouldn't allow the AI to start butchering people without reason
		...
		/obj/item/ai_module/law/core/full/dagothbot, // SKYRAT EDIT - EDITION
		/obj/item/ai_module/law/core/full/texas, // SKYRAT EDIT - EDITION
		/obj/item/ai_module/law/core/full/emperor, // SKYRAT EDIT - EDITION
	)
