...
/obj/effect/landmark/start/prisoner
	name = "Prisoner"
	icon_state = "Prisoner"
	//BUBBER EDIT: Start - Makes latejoin prisoners spawn in the prison instead of on the interlink.
	jobspawn_override = TRUE
	delete_after_roundstart = FALSE
	//BUBBER EDIT: End - Makes latejoin prisoners spawn in the prison instead of on the interlink.
...
/obj/effect/landmark/start/cyborg
	name = "Cyborg"
	icon_state = "Cyborg"
	//BUBBER EDIT: Start - Makes latejoin cyborgs spawn in the station instead of on the interlink.
	jobspawn_override = TRUE
	delete_after_roundstart = FALSE
	//BUBBER EDIT: End - Makes latejoin cyborgs spawn in the station instead of on the interlink.
