...
/obj/structure/mannequin/update_overlays()
	...
	//BUBBER EDIT ADDITION BEGIN - Underwear and Bra split
...
/obj/structure/mannequin/attack_hand_secondary(mob/user, list/modifiers)
	...
	if(. == SECONDARY_ATTACK_CANCEL_ATTACK_CHAIN)
		return
	var/choice = tgui_input_list(user, "Underwear, Bra, Undershirt, or Socks?", "Changing", list("Underwear", "Bra", "Undershirt","Socks")) //BUBBER EDIT ADDITION - Underwear and Bra split
	if(!Adjacent(user))
		return
	switch(choice)
		if("Underwear")
