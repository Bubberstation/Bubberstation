...
/obj/structure/displaycase/captain
	...
	req_access = list(ACCESS_CAPTAIN)	//BUBBER EDIT CHANGE - ORIGINAL: req_access = list(ACCESS_CENT_SPECOPS) //this was intentional, presumably to make it slightly harder for caps to grab their gun roundstart
