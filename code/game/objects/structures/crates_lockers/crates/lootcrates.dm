/obj/structure/closet/crate/loot
	...
	var/list/loot_content = list()

/obj/structure/closet/crate/loot/Initialize(mapload)
	. = ..()
	if(prob(50))
		LAZYADD(loot_content, pick_weight(loot_table_armor))
	if(prob(50))
		LAZYADD(loot_content, pick_weight(loot_table_melee))
	if(prob(70))
		LAZYADD(loot_content, pick_weight(loot_table_heal))
...
/obj/structure/closet/crate/loot/legendary/Initialize(mapload)
	. = ..()
	LAZYADD(loot_content, pick_weight(loot_table_legendary))
