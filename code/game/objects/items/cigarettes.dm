...
/obj/item/vape
	...
	worn_icon_muzzled = 'modular_skyrat/master_files/icons/mob/clothing/mask.dmi' //BUBBER EDIT: ADDITION
	icon_state = "vape"
	...
	greyscale_config_worn_muzzled = /datum/greyscale_config/vape/worn/muzzled //BUBBER EDIT ADDITION
