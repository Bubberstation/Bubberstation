...
/obj/item/implant/radio
	...
	var/radio_type = /obj/item/radio //BUBBER EDIT ADDITION
	var/radio_key
...
/obj/item/implant/radio/Initialize(mapload, radio_key_1, radio_key_2) // BUBBER EDIT CHANGE - ORIGINAL: /obj/item/implant/radio/Initialize(mapload)
	. = ..()

	radio = new radio_type(src) // BUBBER EDIT CHANGE - ORIGINAL: radio = new(src)
