...
GLOBAL_LIST_INIT(channel_tokens, list(
	...
	RADIO_CHANNEL_FACTION = RADIO_TOKEN_FACTION, //BUBBER EDIT ADDITION - Faction
	RADIO_CHANNEL_CYBERSUN = RADIO_TOKEN_CYBERSUN, //BUBBER EDIT ADDITION - Mapping
	RADIO_CHANNEL_INTERDYNE = RADIO_TOKEN_INTERDYNE, //BUBBER EDIT ADDITION - Mapping
	RADIO_CHANNEL_GUILD = RADIO_TOKEN_GUILD, //BUBBER EDIT ADDITION - Mapping
	RADIO_CHANNEL_TARKON = RADIO_TOKEN_TARKON, //BUBBER EDIT ADDITION - MAPPING
	RADIO_CHANNEL_TERRAGOV = RADIO_TOKEN_TERRAGOV, //BUBBER EDIT ADDITION - TERRAGOV
