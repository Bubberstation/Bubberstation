...
GLOBAL_LIST_INIT(wood_recipes, list ( \
	...
	new/datum/stack_recipe("chalkboard", /obj/structure/chalkboard, 5, time = 5 SECONDS, one_per_turf = TRUE, on_solid_ground = TRUE, category = CAT_STRUCTURE), /* BUBBER EDIT: ADDS CHALKBOARD CRAFT */ \
