...
/obj/item/storage/belt/sabre/centcom
	...
	desc = "A beautifully rare sheath designed to look good, and hold a exotic sword without dulling it. You can see 'CENTRAL COMMAND' etched into the gold on the bottom of it."
