...
/datum/crewmonitor
	...
	var/list/jobs = list(
		...
		*/
		...
		JOB_DETECTIVE = 15,
		JOB_SECURITY_OFFICER_MEDICAL = 16,
		JOB_SECURITY_OFFICER_ENGINEERING = 17,
		JOB_SECURITY_OFFICER_SCIENCE = 18,
		JOB_SECURITY_OFFICER_SUPPLY = 19,
		JOB_SECURITY_OFFICER_SERVICE = 29,
		// 20-29: Medbay
