...
/obj/machinery/computer/arena/proc/trophy_for_last_man_standing()
	...
	for(var/mob/living/L in GLOB.mob_living_list)
		if(L.stat != DEAD && (get_turf(L) in arena_turfs))
			var/obj/item/reagent_containers/cup/glass/trophy/gold_cup/G = new /obj/item/reagent_containers/cup/glass/trophy/gold_cup(get_turf(L))
