...
#define MAX_TIMER (60 MINUTES) //BUBBER EDIT CHANGE
//#define PRESET_SHORT (2 MINUTES) //ORIGINAL
#define PRESET_SHORT (5 MINUTES) //BUBBER EDIT CHANGE
//#define PRESET_MEDIUM (3 MINUTES) //ORIGINAL
#define PRESET_MEDIUM (10 MINUTES) //BUBBER EDIT CHANGE
//#define PRESET_LONG (5 MINUTES) //ORIGINAL
#define PRESET_LONG (15 MINUTES) //BUBBER EDIT CHANGE
