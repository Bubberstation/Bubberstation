...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_GALFED = FREQ_GALFED, //BUBBER EDIT ADDITION - GALFED POLICE
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_GALFED]" = RADIO_CHANNEL_GALFED, //BUBBER EDIT ADDITION - GALFED POLICE
...
GLOBAL_LIST_INIT(radiocolors, list(
	...
	RADIO_CHANNEL_GALFED = "#273a79", //BUBBER EDIT ADDITION - GALFED POLICE
))
