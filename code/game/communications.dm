...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_BROADCAST = FREQ_BROADCAST, // EffigyEdit Addition - TM ONLY - EFFIGY PROMO
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_BROADCAST]" = RADIO_CHANNEL_BROADCAST, // EffigyEdit Addition - TM ONLY - EFFIGY PROMO
