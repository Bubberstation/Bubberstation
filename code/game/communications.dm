...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_FACTION = FREQ_FACTION, //BUBBER EDIT ADDITION - FACTION
	RADIO_CHANNEL_CYBERSUN = FREQ_CYBERSUN, //BUBBER EDIT ADDITION - MAPPING
	RADIO_CHANNEL_INTERDYNE = FREQ_INTERDYNE, //BUBBER EDIT ADDITION - MAPPING
	RADIO_CHANNEL_GUILD = FREQ_GUILD, //BUBBER EDIT ADDITION - ASSAULT OPS
	RADIO_CHANNEL_TARKON = FREQ_TARKON, //BUBBER EDIT ADDITION - MAPPING
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_FACTION]" = RADIO_CHANNEL_FACTION, //BUBBER EDIT ADDITION - FACTION
	"[FREQ_CYBERSUN]" = RADIO_CHANNEL_CYBERSUN, //BUBBER EDIT ADDITION - MAPPING
	"[FREQ_INTERDYNE]" = RADIO_CHANNEL_INTERDYNE, //BUBBER EDIT ADDITION - MAPPING
	"[FREQ_TARKON]" = RADIO_CHANNEL_TARKON, //BUBBER EDIT ADDITION - MAPPING
