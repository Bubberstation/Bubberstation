...
/*
	if(ambient_buzz != old_area.ambient_buzz)
		L.refresh_looping_ambience() */ // BUBBER EDIT REMOVAL
...
/* 	var/area/my_area = get_area(src)
	...
	SEND_SOUND(src, sound(my_area.ambient_buzz, repeat = 1, wait = 0, volume = my_area.ambient_buzz_vol, channel = CHANNEL_BUZZ)) */ // BUBBER EDIT REMOVAL
