// REMOVED QUIRK - Merged with Personal Space
/*
/datum/quirk/buns_of_steel
	name = "Buns of Steel"
	desc = "You are completely immune to all forms of ass slapping, and anyone who tries to slap your rock-hard ass usually gets a broken hand!"
	value = 0
