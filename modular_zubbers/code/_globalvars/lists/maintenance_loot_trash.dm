GLOBAL_LIST_INIT(trash_loot, list(//junk: useless, very easy to get, or ghetto chemistry items
	...
	list(
		...
		/obj/item/smokable/black_tar = 1,
		/obj/item/snortable/cocaine = 1,
		/obj/item/smokable/crack = 1,
		/obj/item/reagent_containers/cup/blastoff_ampoule = 1,
		/obj/item/bongable/hash = 1,
		/obj/item/bongable/dab = 1,
		/obj/item/snortable/heroin = 1,
		/obj/item/reagent_containers/cup/bottle/promethazine = 1,
