...
GLOBAL_LIST_INIT(grasping_arms_choice, list(
	"Mantis Arms" = list(/obj/item/bodypart/arm/left/mantis, /obj/item/bodypart/arm/right/mantis),
	"Crab Arms" = list(/obj/item/bodypart/arm/left/crab, /obj/item/bodypart/arm/right/crab)
))
