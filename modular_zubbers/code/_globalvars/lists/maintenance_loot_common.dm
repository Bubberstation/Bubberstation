GLOBAL_LIST_INIT(common_loot, list( //common: basic items
	...
	list(
		...
		/obj/item/storage/belt/holster/hip_holster/cowboy = 1,
	...
	list(
		...
		/obj/item/stack/sheet/animalhide/carbon/human = 10,
		/obj/item/stack/sheet/animalhide/carbon/lizard = 10,
		/obj/item/stack/sheet/animalhide/carbon/monkey = 10,
	...
	list(
		...
		/obj/item/food/grown/flower/poppy = 25,
		/obj/item/food/grown/flower/poppy/opiumpoppy = 25,
		/obj/item/food/grown/pumpkin = 25,
		/obj/item/food/grown/flower/rainbow_flower = 25,
		/obj/item/food/grown/random = 100,
		/obj/item/food/grown/flower/rose = 25,
