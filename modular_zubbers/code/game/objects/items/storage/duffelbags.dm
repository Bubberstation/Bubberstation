/obj/item/storage/backpack/hydro_duffel //No zipping or slowdown on this one, it's a duffelbag in name only
	...
	desc = "A large duffel bag made of metal hydrogen with state of the art zipper for maximum capacity and instant acces to its content."
	icon = 'modular_zubbers/icons/obj/clothing/back/backpack.dmi'
	worn_icon = 'modular_zubbersicons/mob/clothing/back/backpack.dmi'
