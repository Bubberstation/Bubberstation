...
/obj/effect/spawner/random/burgerstation/odd
	...
	loot = list(
		...
		/obj/structure/altar_of_gods = 10,
		/obj/structure/aquarium/prefilled = 100,
		/obj/structure/beebox/premade/random = 50,
		/obj/structure/beebox = 100,
		/obj/structure/bonfire/grill_pre_attached = 200,
		/obj/structure/cannon/trash = 50,
		/obj/structure/carving_block = 100,
		/obj/structure/destructible/cult/pants_altar = 30,
		/obj/structure/guillotine = 50,
		/obj/structure/kitchenspike = 100,
		/obj/structure/loom = 50,
		/obj/structure/mannequin/plastic = 100,
		/obj/structure/mannequin/skeleton = 25,
		/obj/structure/mannequin/wood = 50,
		/obj/structure/mecha_wreckage/clarke = 25,
		/obj/structure/mecha_wreckage/ripley = 50,
		/obj/structure/mecha_wreckage/odysseus = 1,
		/obj/structure/millstone = 10,
		/obj/structure/mob_spawner/rats = 100,
		/obj/structure/sauna_oven = 50,
