...
/obj/item/screwdriver/power/bluespace
	name = "bluespace driver"
	desc = "Goes so fast that a slip could strip a screw instantly."
	icon = 'modular_zubbers/icons/obj/equipment/equipment.dmi'
	icon_state = "bst_drill"
	toolspeed = 0.1
	w_class = WEIGHT_CLASS_SMALL

/obj/item/screwdriver/power/bluespace/get_belt_overlay()
	if(tool_behaviour != TOOL_WRENCH)
		return mutable_appearance('modular_zubbers/icons/obj/clothing/belt_overlays.dmi', "bst_drill")
	return mutable_appearance('modular_zubbers/icons/obj/clothing/belt_overlays.dmi', "bst_drill_on")

/obj/item/crowbar/power/bluespace
	name = "bluespace jaws of life"
	desc = "Jaws of life, powered by bullshit- I mean bluespace."
	icon = 'modular_zubbers/icons/obj/equipment/equipment.dmi'
	icon_state = "bst_jaws"
	toolspeed = 0.1
	w_class = WEIGHT_CLASS_SMALL

/obj/item/crowbar/power/bluespace/get_belt_overlay()
	if(tool_behaviour != TOOL_WIRECUTTER)
		return mutable_appearance('modular_zubbers/icons/obj/clothing/belt_overlays.dmi', "bst_jaws")
	return mutable_appearance('modular_zubbers/icons/obj/clothing/belt_overlays.dmi', "bst_jaws_on")

/obj/item/weldingtool/experimental/bluespace
	name = "bluespace welding tool"
	desc = "Power of the (bluespace) sun, right on your hip."
	icon = 'modular_zubbers/icons/obj/equipment/equipment.dmi'
	icon_state = "bst_welder"
	toolspeed = 0.1
	w_class = WEIGHT_CLASS_SMALL

/obj/item/weldingtool/experimental/bluespace/get_belt_overlay()
	return mutable_appearance('modular_zubbers/icons/obj/clothing/belt_overlays.dmi', "bst_welder")

/obj/item/multitool/abductor/bluespace
	name = "bluespace multitool"
	desc = "Functionally identical, but we gotta maintain the theme."
	icon = 'modular_zubbers/icons/obj/equipment/equipment.dmi'
	icon_state = "bst_multitool"
	inside_belt_icon_state = "multitool_alien"
	toolspeed = 0.1

/obj/item/multitool/abductor/bluespace/get_belt_overlay()
	return mutable_appearance('modular_zubbers/icons/obj/clothing/belt_overlays.dmi', "bst_multitool")
