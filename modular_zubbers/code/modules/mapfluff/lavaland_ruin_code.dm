...
/obj/effect/mob_spawn/ghost_role/human/lavaland_syndicate/shaftminer
	...
	prompt_name = "a syndicate Shaft Miner"
	you_are_text = "You are an Syndicate shaft miner, employed in a top secret research facility developing biological weapons."
	important_text = "If Nanotrasen finds out about your presence here, they will obliterate you. Defend and maintain the secrecy of the base, do not leave or allow it to fall into enemy hands."
...
/obj/effect/mob_spawn/ghost_role/human/lavaland_syndicate
	...
	prompt_name = "a syndicate Bioweapons Scientist"
	you_are_text = "You are a Syndicate bioweapons scientist, employed in a top secret research facility developing biological weapons."
	important_text = "If Nanotrasen finds out about your presence here, they will obliterate you. Defend and maintain the secrecy of the base, do not leave or allow it to fall into enemy hands."

/obj/effect/mob_spawn/ghost_role/human/lavaland_syndicate/deckofficer
	name = "Syndicate Deck Officer"
	prompt_name = "a syndicate Deck Officer"
