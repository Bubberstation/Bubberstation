/datum/heretic_knowledge/watching_eye
	...
	desc = "Allows you to transmute a pair of eyes and a uranium sheet into a watching eye; \
	a special fragile jewel that deals toxin damage over time to non-heretics around it, as long as it is placed on a tile. \
	Use in hand to activate it."
