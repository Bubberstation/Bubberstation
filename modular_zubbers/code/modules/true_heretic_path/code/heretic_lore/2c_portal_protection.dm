/datum/heretic_knowledge/limited_amount/portal_protection
	...
	The place in which you revive will be the place where you complete the transmutation ritual. \
	Once performed, you cannot go back!"
...
/datum/heretic_knowledge/limited_amount/portal_protection/proc/on_heretic_death(gibbed)
	...
	user.revive(HEAL_BRUTE | HEAL_BURN | HEAL_TOX | HEAL_OXY | HEAL_BLOOD | HEAL_WOUNDS | HEAL_LIMBS, excess_healing = 100, force_grab_ghost  = TRUE)

	var/damage_to_deal = round(BRAIN_DAMAGE_DEATH/6,1)

	target.adjustOrganLoss(ORGAN_SLOT_BRAIN,damage_to_deal)

	portals_left--

	to_chat(span_velvet("You feel your soul getting slammed back into your broken body while it is carried away to safety... you have [portals_left] [portals_left == 1 ? "revive" :"revives"] left!")
