...
/datum/heretic_knowledge/flask_purchase/on_finished_recipe(mob/living/user, list/selected_atoms, turf/loc)
	...
	if(locate(/obj/item/food/burger) in loc)
		...
		item_to_create = pick(/obj/item/reagent_containers/cup/endless_flask/healing_juice,/obj/item/reagent_containers/cup/endless_flask/gravitum,/obj/item/reagent_containers/cup/endless_flask/blastoff,/obj/item/reagent_containers/cup/endless_flask/determination)
