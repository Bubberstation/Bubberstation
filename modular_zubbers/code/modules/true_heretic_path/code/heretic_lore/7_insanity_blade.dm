/datum/heretic_knowledge/limited_amount/insanity_blade
	...
	desc = "Allows you to transform a cold iron blade, a brain, and a sheet of plasma into the Elder's insanity sword; a powerful upgraded ritual knife that deals more damage and causes sanity damage to targets, as well as yourself, on hit. \
