/datum/heretic_knowledge/limited_amount/insanity_blade
	...
	desc = "Allows you to transform a cold iron blade, a small fish, and a sheet of plasma into the Elder's insanity sword; a powerful upgraded ritual knife that deals more damage and causes sanity damage to targets, as well as yourself, on hit. \
	The blade also has a 25% chance to block attacks, but is much bulkier and cannot fit in bags. \
	Interesting enough, negative modifier values on the item are converted to positive modifiers. \
