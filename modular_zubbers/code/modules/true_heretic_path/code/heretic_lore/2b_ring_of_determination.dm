/datum/heretic_knowledge/determination
	...
	desc = "Allows you to transmute a piece of body armor and a helmet into a powerful ring that passively gives protection from melee and bullet based attacks."
