...
/datum/uplink_item/dangerous/regal_condor_kit
	...
	desc = "An ominous kit of gun parts in a sleek suitcase, containing several raw telecrystals. The kit was supplied with a note that says /"You'll figure out the rest/"."
