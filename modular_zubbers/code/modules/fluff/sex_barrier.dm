...
/obj/structure/holosign/sexsign
	name = "sex sign"
	desc = "The words flicker DON'T SEX OPEN INSIDE. I think this means that there is sex beyond this door and that you should probably not enter, unless of course you are prepared for unforeseen consequences (Such as a Teshari with \"Dom - Yes\" or an abductor with \"ANAL ONLY\")."
