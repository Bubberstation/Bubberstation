...
/datum/species/lycan/proc/organ_reject(mob/living/source, obj/item/organ/inserted)
	SIGNAL_HANDLER
	if(isnull(source))
		return
...
/datum/species/lycan/proc/reject_now(mob/living/source, obj/item/organ/organ)
	organ.Remove(source)
...
/datum/species/lycan/on_species_loss(mob/living/carbon/human/gainer, datum/species/new_species, pref_load)
	. = ..()
