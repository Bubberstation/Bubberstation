...
!((t, n) => {
  ...
  function r(n, i) {
    ...
    if (!r) {
      if (
        ...
        return {
          s: o,
          n: () => (e >= n.length ? { done: !0 } : { done: !1, value: n[e++] }),
          e: (t) => {
            throw t;
          },
          f: o,
  ...
  function M(t) {
    return t.reduce((t, n) => t + n.length, 0);
  }
  function x(t, n) {
  ...
  function _(t) {
    for (
      ...
      i[r - 1] = arguments[r];
    return i.reduce((n, i) => (Object.hasOwn(t, i) && (n[i] = t[i]), n), {});
  }
  var D = L.setTimeout,
    P = L.clearTimeout;
  function $(t, n) {
  ...
  var K = ((t) => {
      ...
      return (
        (i.doWrite = function (t, n) {
          ...
          r.on('success', n),
            r.on('error', (t, n) => {
              this.onError('xhr post error', t, n);
            });
        }),
        (i.doPoll = function () {
          var n = this.request();
          ...
          try {
            ...
            try {
              if (this.l.extraHeaders)
                ...
                this.l.extraHeaders))
                  Object.hasOwn(this.l.extraHeaders, o) &&
                ...
                3 === e.readyState &&
                  ...
                  4 === e.readyState &&
                    (200 === e.status || 1223 === e.status
                      ? this.O()
                      : this.setTimeoutFn(() => {
                          this.B('number' == typeof e.status ? e.status : 0);
                        }, 0));
              }),
              e.send(this.k);
          } catch (t) {
  ...
  function G() {
    for (var t in Y.requests)
      Object.hasOwn(Y.requests, t) && Y.requests[t].abort();
  }
  var Q,
  ...
  var nt =
    ...
    it = ((t) => {
      ...
      return (
        ...
        (r.addEventListeners = function () {
          (this.ws.onopen = () => {
            this.opts.autoUnref && this.ws.C.unref(), this.onOpen();
          }),
            (this.ws.onclose = (n) =>
              this.onClose({
    ...
    et = ((t) => {
      ...
      var i = n.prototype;
      return (
        (i.createSocket = (t, n, i) =>
          nt ? new rt(t, n, i) : n ? new rt(t, n) : new rt(t)),
        (i.doWrite = function (t, n) {
          this.ws.send(n);
        }),
        n
      ...
      return (
        (r.doOpen = function () {
          ...
          this.T.closed
            ...
            this.T.ready.then(() => {
              t.T.createBidirectionalStream().then((n) => {
                var i = ((t, n) => {
                    O || (O = new TextDecoder());
                    var i = [],
                      r = 0,
      ...
      (i.setTransport = function (t) {
        this.transport && this.transport.removeAllListeners(),
          ...
          t
            ...
            .on('close', (t) => this.F('transport close', t));
      }),
      (i.onOpen = function () {
        (this.readyState = 'open'),
      ...
      return (
        ...
        (i.tt = function (t) {
          ...
          var s = (t) => {
            ...
            (r.transport = i.name), o(), this.emitReserved('upgradeError', r);
          };
          function u() {
            s('transport closed');
          }
  ...
  function kt(t, n) {
    ...
    for (var e in t) if (Object.hasOwn(t, e) && kt(t[e])) return !0;
    return !1;
  }
  function At(t) {
    var n = [],
  ...
  function jt(t, n) {
    ...
    if ('object' === c(t) && !(t instanceof Date)) {
      var o = {};
      for (var s in t) Object.hasOwn(t, s) && (o[s] = jt(t[s], n));
      return o;
    }
    return t;
  }
  ...
  function Ot(t, n) {
    ...
    if (Array.isArray(t)) for (var i = 0; i < t.length; i++) t[i] = Ot(t[i], n);
      ...
      for (var r in t) Object.hasOwn(t, r) && (t[r] = Ot(t[r], n));
    return t;
  }
  var Bt,
    St = [
      ...
      return (
        ...
        (o.emitWithAck = function (t) {
          ...
          return new Promise((i, e) => {
            var o = (t, n) => (t ? e(t) : i(n));
            (o.withError = !0), r.push(o), this.emit.apply(this, [t].concat(r));
          });
        }),
        (o.ut = function (t) {
          var n;
          ...
          t.push((t) => {
            if (r === this.it[0]) {
              if (null !== t)
                r.tryCount > this.l.retries && (this.it.shift(), n && n(t));
              else if ((this.it.shift(), n)) {
                for (
        ...
        (o.yt = function () {
          Object.keys(this.acks).forEach((n) => {
            if (!this.sendBuffer.some((t) => String(t.id) === n)) {
              var i = this.acks[n];
              delete this.acks[n],
                i.withError &&
          ...
          return () => {
            if (!i) {
              ...
              for (
                ...
                e[o] = arguments[o];
              this.packet({ type: Bt.ACK, id: t, data: e });
            }
          };
        }),
        (o.onack = function (t) {
  ...
  (_t.prototype.duration = function () {
    var t = this.ms * this.factor ** this.attempts++;
    if (this.jitter) {
      var n = Math.random(),
          ...
          var e = It(i, 'open', () => {
            ...
            o = (i) => {
              this.cleanup(),
                ...
                t ? t(i) : this.maybeReconnectOnOpen();
            },
            s = It(i, 'error', o);
          if (!1 !== this.Bt) {
            var u = this.Bt,
