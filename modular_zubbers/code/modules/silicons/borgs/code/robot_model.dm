...
/obj/item/robot_model/medical/Initialize(mapload)
	...
	borg_skins |= list(
		...
		"Lupus" = list(
			SKIN_ICON_STATE = "lupus_med",
			SKIN_ICON = CYBORG_ICON_LUPUS_MED,
			SKIN_FEATURES = list(TRAIT_R_HAS_UNIQUE_RESTING_LIGHTS, TRAIT_R_UNIQUEPANEL)
		),
	)
...
/obj/item/robot_model/engineering/Initialize(mapload)
	...
	borg_skins |= list(
		...
		"Lupus" = list(
			SKIN_ICON_STATE = "lupus_engi",
			SKIN_ICON = CYBORG_ICON_LUPUS_ENGI,
			SKIN_FEATURES = list(TRAIT_R_HAS_UNIQUE_RESTING_LIGHTS, TRAIT_R_UNIQUEPANEL)
		),
	)
...
/obj/item/robot_model/janitor/Initialize(mapload)
	...
	borg_skins |= list(
		...
		"Lupus" = list(
			SKIN_ICON_STATE = "lupus_jani",
			SKIN_ICON = CYBORG_ICON_LUPUS_JANI,
			SKIN_FEATURES = list(TRAIT_R_HAS_UNIQUE_RESTING_LIGHTS, TRAIT_R_UNIQUEPANEL)
		),
	)
...
/obj/item/robot_model/miner/Initialize(mapload)
	...
	borg_skins |= list(
		...
		"Lupus" = list(
			SKIN_ICON_STATE = "lupus_mine",
			SKIN_ICON = CYBORG_ICON_LUPUS_MINING,
...
/obj/item/robot_model/security/Initialize(mapload)
	...
	borg_skins |= list(
		...
		"lupus" = list(
			SKIN_ICON_STATE = "lupus_sec",
			SKIN_ICON = CYBORG_ICON_LUPUS_SEC,
			SKIN_FEATURES = list(TRAIT_R_UNIQUEPANEL, TRAIT_R_HAS_UNIQUE_RESTING_LIGHTS)
		),
	)
...
/obj/item/robot_model/peacekeeper/Initialize(mapload)
	...
	borg_skins |= list(
		...
		"Lupus" = list(
			SKIN_ICON_STATE = "lupus_peace",
			SKIN_ICON = CYBORG_ICON_LUPUS_PEACE,
			SKIN_FEATURES = list(TRAIT_R_UNIQUEPANEL, TRAIT_R_HAS_UNIQUE_RESTING_LIGHTS)
		)
	)
