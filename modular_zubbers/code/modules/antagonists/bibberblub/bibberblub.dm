/mob/living/basic/bibberblub
	...
	var/datum/action/cooldown/bibberblub_spit/spit_ability
...
/mob/living/basic/bibberblub/examine(mob/user)
	. = ..()
	if (user == src)
		. += span_bold("You have the following resources:")
		. += span_boldnicegreen("[nutriment_resource] Nutriment")
