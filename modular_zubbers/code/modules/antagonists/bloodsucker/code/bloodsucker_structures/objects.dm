...
/obj/item/reagent_containers/blood/o_minus/bloodsucker/examine(mob/user)
	. = ..()
	if(user.mind.has_antag_datum(/datum/antagonist/vassal/ex_vassal) || user.mind.has_antag_datum(/datum/antagonist/vassal/revenge))
...
/obj/item/stake
	...
	icon = 'modular_zubbers/code/modules/antagonists/bloodsucker/icons/stakes.dmi'
	icon_state = "wood"
