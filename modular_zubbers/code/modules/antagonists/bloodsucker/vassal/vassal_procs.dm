...
/datum/antagonist/ghoul/proc/make_special(datum/antagonist/ghoul/ghoul_type)
	...
	to_chat(master, span_danger("You have turned [ghoul_owner.current] into your [ghouldatum.name]!"))
	to_chat(ghoul_owner, span_notice("As blood drips over your body, you feel closer to your Master... You are now the Favorite Ghoul!"))
