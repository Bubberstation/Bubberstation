...
/datum/bloodsucker_clan/New(datum/antagonist/bloodsucker/owner_datum)
	...
	RegisterSignal(bloodsuckerdatum, BLOODSUCKER_INTERACT_WITH_GHOUL, PROC_REF(on_interact_with_ghoul))
	RegisterSignal(bloodsuckerdatum, BLOODSUCKER_MAKE_FAVORITE, PROC_REF(favorite_ghoul_gain))
	RegisterSignal(bloodsuckerdatum, BLOODSUCKER_LOOSE_FAVORITE, PROC_REF(favorite_ghoul_loss))

	RegisterSignal(bloodsuckerdatum, BLOODSUCKER_MADE_GHOUL, PROC_REF(on_ghoul_made))
...
/datum/bloodsucker_clan/Destroy(force)
	UnregisterSignal(bloodsuckerdatum, list(
		...
		BLOODSUCKER_RANK_UP,
		BLOODSUCKER_INTERACT_WITH_GHOUL,
		BLOODSUCKER_MAKE_FAVORITE,
		BLOODSUCKER_MADE_GHOUL,
