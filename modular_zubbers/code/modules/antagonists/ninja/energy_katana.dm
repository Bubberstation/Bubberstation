...
//Piercing: 23 damage, 50 penetration.
...
/obj/item/energy_katana/advanced
...
/obj/item/energy_katana/advanced/Initialize(mapload)
	. = ..()
	AddComponent(
...
/obj/item/energy_katana/advanced/proc/on_transform(obj/item/source, mob/user, active)
	SIGNAL_HANDLER
	if(active)
...
/datum/action/innate/dash/ninja/advanced/teleport(mob/user, atom/target)
