/obj/item/clothing/under/rank/lace
    ...
    lefthand_file = 'modular_zubbers/icons/mob/clothing/inhands/lace_lefthand.dmi'
    righthand_file = 'modular_zubbers/icons/mob/clothing/inhands/lace_righthand.dmi'
