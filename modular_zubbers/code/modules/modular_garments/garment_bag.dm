/obj/item/storage/bag/garment/zubbers/nanotrasen_consultant
...
/obj/item/storage/bag/garment/zubbers/nanotrasen_consultant/PopulateContents()
	...
	new /obj/item/clothing/head/beret/centcom_formal/official/nt_consultant(src)
