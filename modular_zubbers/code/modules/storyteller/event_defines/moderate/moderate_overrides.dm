...
/datum/round_event_control/processor_overload
	track = EVENT_TRACK_MODERATE
	tags = list(TAG_COMMUNAL)
	restriction_tags = DEPARTMENT_BITFLAG_ENGINEERING | DEPARTMENT_BITFLAG_SCIENCE //In 60% cases this requires research to rebuild. Yes, I know there is generally spare parts but still.
	restriction_tag_requirement = 2
