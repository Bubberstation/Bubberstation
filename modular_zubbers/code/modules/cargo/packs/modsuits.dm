/datum/supply_pack/imports/modsuit
	access = NONE
	cost = PAYCHECK_CREW
	group = "MODSuits"
...
/datum/supply_pack/imports/modsuit/mod_module/retract_plates
...
/datum/supply_pack/imports/modsuit/mod_module/disposals
...
/datum/supply_pack/imports/modsuit/mod_module/atrocinator
...
/datum/supply_pack/imports/modsuit/mod_module/bikehorn
...
/datum/supply_pack/imports/modsuit/mod_module/microwavebeam
...
/datum/supply_pack/imports/modsuit/mod_module/tanner
...
/datum/supply_pack/imports/modsuit/mod_module/medical/
	cost = PAYCHECK_COMMAND * 2

/datum/supply_pack/imports/modsuit/mod_module/medical/injector
	name = "MOD Injector Module"
	contains = list(/obj/item/mod/module/injector)

/datum/supply_pack/imports/modsuit/mod_module/medical/organizer
	name = "MOD Organizer Module"
	contains = list(/obj/item/mod/module/organizer)

/datum/supply_pack/imports/modsuit/mod_module/medical/patient_transport
	name = "MOD Patient Transport Module"
	contains = list(/obj/item/mod/module/criminalcapture/patienttransport)

/datum/supply_pack/imports/modsuit/mod_module/medical/thread_ripper
	name = "MOD Thread Ripper Module"
	contains = list(/obj/item/mod/module/thread_ripper)

/datum/supply_pack/imports/modsuit/mod_module/medical/surgical_processor
	name = "MOD Surgical Processor Module"
	contains = list(/obj/item/mod/module/surgical_processor)

/datum/supply_pack/imports/modsuit/mod_module/medical/defibrillator
	name = "MOD Defibrillator Module"
	contains = list(/obj/item/mod/module/defibrillator)

/datum/supply_pack/imports/modsuit/mod_module/donk/dart_collector_safe
	name = "MOD Dart Collector"
	cost = PAYCHECK_COMMAND
	contains = list(/obj/item/mod/module/recycler/donk/safe)

/datum/supply_pack/imports/modsuit/mod_module/donk/dart_collector_unsafe
