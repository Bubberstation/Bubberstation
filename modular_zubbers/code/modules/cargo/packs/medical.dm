...
/datum/supply_pack/goody/medical/medpen/occuisate
...
/datum/supply_pack/goody/medical/defibrillator_penlite
	contains = list(/obj/item/wallframe/defib_mount/charging)
	cost = PAYCHECK_COMMAND

/datum/supply_pack/goody/medical/advanced_scalpel
	contains = list(/obj/item/scalpel/advanced)
	cost = PAYCHECK_COMMAND * 10.25

/datum/supply_pack/goody/medical/advanced_retractor
	contains = list(/obj/item/retractor/advanced)
	cost = PAYCHECK_COMMAND * 9

/datum/supply_pack/goody/medical/advanced_cautery
	contains = list(/obj/item/cautery/advanced)
	cost = PAYCHECK_COMMAND * 9

/datum/supply_pack/goody/medical/advanced_blood_filter
	contains = list(/obj/item/blood_filter/advanced)
	cost = PAYCHECK_COMMAND * 9

/datum/supply_pack/goody/medical/medigun_upgrade
...
/datum/supply_pack/goody/medical/afad
...
/datum/supply_pack/goody/medical/medhud
	contains = list(/obj/item/clothing/glasses/hud/health)
	cost = PAYCHECK_COMMAND

/datum/supply_pack/goody/medical/medhud_night
...
/datum/supply_pack/goody/medical/hypospray_case
