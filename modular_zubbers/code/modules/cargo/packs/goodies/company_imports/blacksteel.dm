/datum/supply_pack/goody/company_import/blacksteel
	subcategory = "Blacksteel Industries"

/datum/supply_pack/goody/company_import/blacksteel/blade/hunting_knife
	item_type = /obj/item/knife/hunting
	cost = PAYCHECK_CREW * 2

/datum/supply_pack/goody/company_import/blacksteel/blade/survival_knife
	item_type = /obj/item/knife/combat/survival
	cost = PAYCHECK_CREW * 2

/datum/supply_pack/goody/company_import/blacksteel/blade/bowie_knife
	item_type = /obj/item/storage/belt/bowie_sheath
	cost = PAYCHECK_COMMAND * 3

/datum/supply_pack/goody/company_import/blacksteel/blade/shamshir_sabre
	item_type = /obj/item/storage/belt/sheath/sabre/cargo
	cost = PAYCHECK_COMMAND * 6

/datum/supply_pack/goody/company_import/blacksteel/forging_tools/billows
	item_type = /obj/item/forging/billow
	cost = PAYCHECK_LOWER

/datum/supply_pack/goody/company_import/blacksteel/forging_tools/hammer
	item_type = /obj/item/forging/hammer
	cost = PAYCHECK_LOWER

/datum/supply_pack/goody/company_import/blacksteel/forging_tools/tongs
	item_type = /obj/item/forging/tongs
	cost = PAYCHECK_LOWER

/datum/supply_pack/goody/company_import/blacksteel/forging_metals/fake_cobalt
...
/datum/supply_pack/goody/company_import/blacksteel/forging_metals/fake_copper
...
/datum/supply_pack/goody/company_import/blacksteel/forging_metals/fake_really_blue_aluminum
...
/datum/supply_pack/goody/company_import/blacksteel/forging_metals/fake_brass
