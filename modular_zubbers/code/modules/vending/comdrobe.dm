...
/obj/machinery/vending/access/command/build_access_list(list/access_lists)
	...
	access_lists["[ACCESS_HOS]"] = list(
		...
		/obj/item/clothing/under/rank/security/head_of_security = 1,
		...
		/obj/item/clothing/under/rank/security/head_of_security/red = 1,
		/obj/item/clothing/under/rank/security/head_of_security/red/skirt = 1,
		/obj/item/clothing/under/rank/security/head_of_security/red/alt = 1,
		/obj/item/clothing/under/rank/security/head_of_security/red/alt/skirt = 1,
