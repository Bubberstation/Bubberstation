	...
	product_categories = list(
		list(
			...
			"products" = list(
					...
					/obj/item/clothing/under/rank/security/officer/viro/skirt/dress = 6,
					/obj/item/clothing/under/rank/security/officer/viro/shorts = 6,
					/obj/item/clothing/under/rank/security/officer/viro/polo = 6,
					...
					/obj/item/clothing/mask/balaclava_sec = 6,
		...
		list(
			...
			"icon" = "notes-medical",
			"products" = list(
					/obj/item/clothing/under/rank/security/officer/viro/security_medic = 3,
					/obj/item/clothing/under/rank/security/officer/viro/security_medic/skirt = 3,
					/obj/item/clothing/under/rank/security/officer/viro/security_medic/jumpsuit = 3,
					/obj/item/clothing/under/rank/security/officer/viro/security_medic/scrubs = 3,
					/obj/item/clothing/suit/armor/vest/security_medic = 3,
					/obj/item/clothing/suit/armor/vest/security_medic/jacket = 3,
					/obj/item/clothing/suit/armor/vest/security_medic/hazvest = 3,
					/obj/item/clothing/head/beret/sec/viro/security_medic = 3,
					/obj/item/clothing/head/helmet/sec/secmed = 3,
					/obj/item/clothing/head/soft/sec/secmed = 3,
				)
			),
		list(
			"name" = "Corrections",
