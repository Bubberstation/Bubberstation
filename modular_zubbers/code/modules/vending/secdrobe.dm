	...
	product_categories = list(
		list(
			...
			"products" = list(
					...
					/obj/item/clothing/under/rank/security/officer/red = 6,
					/obj/item/clothing/under/rank/security/officer/red/skirt = 6,
					/obj/item/clothing/under/rank/security/officer/red/battledress = 6,
					/obj/item/clothing/under/rank/security/officer/red/battledress/turtleneck = 6,
		...
		list(
			...
			"products" = list(
					...
					/obj/item/clothing/head/playbunnyears/brig_phys = 6,
					/obj/item/clothing/under/rank/security/brig_phys_bunnysuit = 6,
					/obj/item/clothing/suit/toggle/labcoat/skyrat/security_medic/doctor_tailcoat = 6,
					/obj/item/clothing/neck/tie/bunnytie/brig_phys = 6, 								// Bunnysuit increases as a middle of the road option to keep limited amounts of sec bunnysuits existant.
