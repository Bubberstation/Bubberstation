	...
	product_categories = list(
		list(
			...
			"products" = list(
					...
					/obj/item/clothing/suit/armor/vest/alt/sec/tailcoat = 6,
					...
					/obj/item/clothing/suit/armor/vest/alt/sec/tailcoat/assistant = 6,
		...
		list(
			...
			"products" = list(
					...
					/obj/item/clothing/suit/toggle/labcoat/doctor_tailcoat/brigmed = 3,
