/datum/language/spinwarder
	name = "Interslavic"
	desc = "An elaborate mix of various Slavic languages with similar properties that has long since become the official language of the NRI, \
		with a steady amount of relevance in Terran colonies, various types of trading posts, and spaceports across Human space -\
		it even managed to find a niche in communication with other species."
	key = "P"
	space_chance = 20
	sentence_chance = 0
