...
/datum/species/xeno/get_species_lore()
	return list(
		...
		They tend to lack social skills, being notably quieter than their galactic counterparts, but with experience, most hybrids can easily do away with this problem and fit well \
		into the social spaces they are brought into. If you can forgive the teeth.",
		...
		As a result, the United Hives formed atop the ruins of the Ombrux, fiercely isolationist slavers at the edge of Federation space, \
