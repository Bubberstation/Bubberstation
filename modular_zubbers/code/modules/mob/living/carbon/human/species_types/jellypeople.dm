...
/datum/species/jelly/get_species_description()
	return list("A species essentially crafted whole-cloth by Nanotrasen's R&D department in Sector C7, slimepeople were produced by uplifting xenobiological slimes made in a laboratory environment.\
