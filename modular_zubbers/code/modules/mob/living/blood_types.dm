...
/datum/blood_type/namehere/alt_color/New(datum/blood_type/override_blood_type)
	. = ..()
	src.id = type_key()
...
/datum/blood_type/human/a_minus/alt_color/New(datum/blood_type/override_blood_type)
	src.id = type_key()
	src.color = override_blood_type.color
...
/datum/blood_type/human/a_plus/alt_color/New(datum/blood_type/override_blood_type)
	src.id = type_key()
	src.color = override_blood_type.color
...
/datum/blood_type/human/a_plus/alt_color
	root_abstract_type = /datum/blood_type/human
/datum/blood_type/human/b_minus/alt_color/New(datum/blood_type/override_blood_type)
	src.id = type_key()
	src.color = override_blood_type.color
...
/datum/blood_type/human/ab_minus/alt_color/New(datum/blood_type/override_blood_type)
	src.id = type_key()
	src.color = override_blood_type.color
...
/datum/blood_type/human/ab_plus/alt_color/New(datum/blood_type/override_blood_type)
	src.id = type_key()
	src.color = override_blood_type.color
...
/datum/blood_type/human/o_minus/alt_color/New(datum/blood_type/override_blood_type)
	src.id = type_key()
	src.color = override_blood_type.color
...
/datum/blood_type/human/o_plus/alt_color/New(datum/blood_type/override_blood_type)
	src.id = type_key()
	src.color = override_blood_type.color
...
/datum/blood_type/animal/alt_color/New(datum/blood_type/override_blood_type)
	src.id = type_key()
	src.color = override_blood_type.color
...
/datum/blood_type/oil/alt_color/New(datum/blood_type/override_blood_type)
	src.id = type_key()
	src.color = override_blood_type.color
...
/datum/blood_type/vampire/alt_color/New(datum/blood_type/override_blood_type)
	src.id = type_key()
	src.color = override_blood_type.color
...
/datum/blood_type/universal/alt_color/New(datum/blood_type/override_blood_type)
	src.id = type_key()
	src.color = override_blood_type.color
...
/datum/blood_type/meat/alt_color/New(datum/blood_type/override_blood_type)
	src.id = type_key()
	src.color = override_blood_type.color
...
/datum/blood_type/slime/alt_color/New(datum/blood_type/override_blood_type)
	src.id = type_key()
	src.color = override_blood_type.color
...
/datum/blood_type/water/alt_color/New(datum/blood_type/override_blood_type)
	src.id = type_key()
	src.color = override_blood_type.color
...
/datum/blood_type/snail/alt_color/New(datum/blood_type/override_blood_type)
	src.id = type_key()
	src.color = override_blood_type.color
...
/datum/blood_type/nanite_slurry/alt_color/New(datum/blood_type/override_blood_type)
	src.id = type_key()
	src.color = override_blood_type.color
