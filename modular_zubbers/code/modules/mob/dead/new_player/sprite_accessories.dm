...
/datum/sprite_accessory/clothing/socks/warm_thigh
	name = "Warm Thigh Highs"
	icon_state = "warm_thigh"
	use_static = null
	icon = 'modular_zubbers/master_files/icons/mob/sprite_accessory/clothing.dmi'

/datum/sprite_accessory/clothing/socks/warm_ankle
	name = "Warm Ankle Socks"
	icon_state = "warm_ankle"
	use_static = null
	icon = 'modular_zubbers/master_files/icons/mob/sprite_accessory/clothing.dmi'

/datum/sprite_accessory/clothing/socks/warm_short
	name = "Warm Short Socks"
	icon_state = "warm_short"
	use_static = null
	icon = 'modular_zubbers/master_files/icons/mob/sprite_accessory/clothing.dmi'

/datum/sprite_accessory/clothing/socks/recolor_thigh
	name = "NonTemp Thigh Highs"
	icon_state = "recolor_thigh"
	use_static = null
	icon = 'modular_zubbers/master_files/icons/mob/sprite_accessory/clothing.dmi'

/datum/sprite_accessory/clothing/socks/cool_thighs
	name = "Cool thigh highs."
	icon_state = "cool_thighs"
	use_static = null
	icon = 'modular_zubbers/master_files/icons/mob/sprite_accessory/clothing.dmi'

/datum/sprite_accessory/clothing/socks/cool_ankle
	name = "Cool Ankle Socks."
	icon_state = "cool_ankle"
	use_static = null
	icon = 'modular_zubbers/master_files/icons/mob/sprite_accessory/clothing.dmi'

/datum/sprite_accessory/clothing/socks/cool_short
	name = "Cool Short Socks."
	icon_state = "cool_short"
	use_static = null
	icon = 'modular_zubbers/master_files/icons/mob/sprite_accessory/clothing.dmi'

/datum/sprite_accessory/clothing/socks/grey_ankle
	name = "Nontemp ankle socks."
	icon_state = "grey_ankle"
	use_static = null
	icon = 'modular_zubbers/master_files/icons/mob/sprite_accessory/clothing.dmi'

/datum/sprite_accessory/clothing/socks/grey_short
