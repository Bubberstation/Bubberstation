/obj/item/reagent_containers/hypospray/medipen/survival/luxury/synth
	name = "synth emergency repair one-use hypopen"
	desc = "Cutting edge bluespace technology allowed Nanotrasen to compact 60u of volume into a single hypopen injection. Contains rare and powerful chemicals used to aid synthetic species in exploration of very hard enviroments. WARNING: DO NOT MIX WITH EPINEPHRINE OR ATROPINE."
...
/datum/orderable_item/consumables/luxury_pen/synth
	purchase_path = /obj/item/reagent_containers/hypospray/medipen/survival/luxury/synth
	cost_per_order = 750
