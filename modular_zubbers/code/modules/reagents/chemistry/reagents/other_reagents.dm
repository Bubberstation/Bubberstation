...
/datum/reagent/mutationtoxin/abductor
	mutationtexts = list( "Your skin is turning grey." = MUT_MSG_IMMEDIATE,
...
/datum/reagent/mutationtoxin/akula
	...
	mutationtexts = list( "You feel itchy." = MUT_MSG_IMMEDIATE,
...
/datum/reagent/mutationtoxin/anthromorph
	...
	chemical_flags = REAGENT_CAN_BE_SYNTHESIZED|REAGENT_NO_RANDOM_RECIPE
	mutationtexts = list( "You feel pin pricks on your skin." = MUT_MSG_IMMEDIATE,
...
/datum/reagent/mutationtoxin/ash
	mutationtexts = list( "You feel very cold." = MUT_MSG_IMMEDIATE,
...
/datum/reagent/mutationtoxin/dwarf
	...
	chemical_flags = REAGENT_CAN_BE_SYNTHESIZED|REAGENT_NO_RANDOM_RECIPE
	mutationtexts = list( "You feel a desire for some ale." = MUT_MSG_IMMEDIATE,
...
/datum/reagent/mutationtoxin/ethereal
	...
	chemical_flags = REAGENT_CAN_BE_SYNTHESIZED|REAGENT_NO_RANDOM_RECIPE
	mutationtexts = list( "You feel your skin tingle." = MUT_MSG_IMMEDIATE,
...
/datum/reagent/mutationtoxin/felinid/primitive
	...
	chemical_flags = REAGENT_CAN_BE_SYNTHESIZED|REAGENT_NO_RANDOM_RECIPE
	mutationtexts = list( "Your mind feels clouded." = MUT_MSG_IMMEDIATE,
									"Your hair stands on end." = MUT_MSG_IMMEDIATE,
...
/datum/reagent/mutationtoxin/fly
	mutationtexts = list( "Your tongue tingles." = MUT_MSG_IMMEDIATE,
...
/datum/reagent/mutationtoxin/ghoul
	...
	chemical_flags = REAGENT_CAN_BE_SYNTHESIZED|REAGENT_NO_RANDOM_RECIPE
	mutationtexts = list( "Your muscles are sore." = MUT_MSG_IMMEDIATE,
									"Your stomach churns." = MUT_MSG_IMMEDIATE,
...
/datum/reagent/mutationtoxin/golem
	mutationtexts = list( "You feel like you have gravel in your stomach." = MUT_MSG_IMMEDIATE,
...
/datum/reagent/mutationtoxin/jelly
	mutationtexts = list( "Your mouth feels gooey" = MUT_MSG_IMMEDIATE,
...
/datum/reagent/mutationtoxin/lizard
	mutationtexts = list( "You feel cold." = MUT_MSG_IMMEDIATE,
									"Your skin feels dry." = MUT_MSG_IMMEDIATE,
...
/datum/reagent/mutationtoxin/monkey
	...
	chemical_flags = REAGENT_CAN_BE_SYNTHESIZED|REAGENT_NO_RANDOM_RECIPE
	mutationtexts = list( "You breathe through your mouth." = MUT_MSG_IMMEDIATE,
...
/datum/reagent/mutationtoxin/moth
	mutationtexts = list( "Your eyes suddenly become very light sensitive." = MUT_MSG_IMMEDIATE,
...
/datum/reagent/mutationtoxin/plasma
	mutationtexts = list( "You have a sharp pain in your stomach" = MUT_MSG_IMMEDIATE,
...
/datum/reagent/mutationtoxin/pod
	mutationtexts = list( "Your skin begins to have a green tinge." = MUT_MSG_IMMEDIATE,
...
/datum/reagent/mutationtoxin/shadekin
	...
	chemical_flags = REAGENT_CAN_BE_SYNTHESIZED|REAGENT_NO_RANDOM_RECIPE
	mutationtexts = list( "You feel at home in the darkness." = MUT_MSG_IMMEDIATE,
									"You notice a dusting of hair covering your body." = MUT_MSG_IMMEDIATE,
									"You are getting furrier." = MUT_MSG_EXTENDED,
...
/datum/reagent/mutationtoxin/skeleton
	mutationtexts = list( "You are losing weight" = MUT_MSG_IMMEDIATE,
...
/datum/reagent/mutationtoxin/skrell
	...
	chemical_flags = REAGENT_CAN_BE_SYNTHESIZED|REAGENT_NO_RANDOM_RECIPE
	mutationtexts = list( "Your skin feels rubbery" = MUT_MSG_IMMEDIATE,
...
/datum/reagent/mutationtoxin/vox
	...
	chemical_flags = REAGENT_CAN_BE_SYNTHESIZED|REAGENT_NO_RANDOM_RECIPE
	mutationtexts = list( "Your throat feels scratchy." = MUT_MSG_IMMEDIATE,
...
/datum/reagent/mutationtoxin/zombie
	mutationtexts = list( "You notice a foul smell. It is you." = MUT_MSG_IMMEDIATE,
