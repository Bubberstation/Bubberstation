...
/datum/controller/subsystem/holomaps/proc/generate_default_holomap_legend()
	for(var/department_color in GLOB.holomap_color_to_name)
		var/image/marker_icon = image('modular_zubbers/icons/obj/machines/holomap/8x8.dmi', "area_legend")
		var/icon/marker_color_overlay = icon('modular_zubbers/icons/obj/machines/holomap/8x8.dmi', "area_legend")
		...
		for(var/y = 1 to world.maxy)
			...
			if(istype(z_transition_obj, /obj/structure/stairs))
				if(!z_transition_positions["Stairs Up"])
					z_transition_positions["Stairs Up"] = list("icon" = image('modular_zubbers/icons/obj/machines/holomap/8x8.dmi', "stairs"), "color" = "#00FF00", "markers" = list())

				image_to_use = image('modular_zubbers/icons/obj/machines/holomap/8x8.dmi', "stairs")
				...
				image_to_use = image('modular_zubbers/icons/obj/machines/holomap/8x8.dmi', "stairs_down")
				...
				if(!transitions["Stairs Down"])
					transitions["Stairs Down"] = list("icon" = image('modular_zubbers/icons/obj/machines/holomap/8x8.dmi', "stairs_down"), "color" = "#009933", "markers" = list())

				transitions["Stairs Down"]["markers"] += image_to_use
				continue

			if(!z_transition_positions["Ladders"])
				z_transition_positions["Ladders"] = list("icon" = image('modular_zubbers/icons/obj/machines/holomap/8x8.dmi', "ladder"), "color" = "#0099CC", "markers" = list())

			image_to_use = image('modular_zubbers/icons/obj/machines/holomap/8x8.dmi', "ladder")
			image_to_use.pixel_x = offset_x
			image_to_use.pixel_y = offset_y
