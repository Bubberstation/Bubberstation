/obj/item/bong
	...
	icon = 'modular_zubbers/modules/morenarcotics/icons/bong.dmi'
	lefthand_file = 'modular_zubbers/modules/morenarcotics/icons/lefthand.dmi'
	righthand_file = 'modular_zubbers/modules/morenarcotics/icons/righthand.dmi'
	icon_state = "bongoff"
