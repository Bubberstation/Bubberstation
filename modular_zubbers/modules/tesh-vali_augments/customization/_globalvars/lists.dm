...
GLOBAL_LIST_INIT(robotic_styles_list += list(
	"Ceremi Cybernetics" = 'modular_zubbers/modules/tesh-vali_augments/icons/augments_teshvali.dmi',
	"Ceremi Cybernetics Prototype" = 'modular_zubbers/modules/tesh-vali_augments/icons/surplus_augments_teshvali.dmi',
	))
*/
