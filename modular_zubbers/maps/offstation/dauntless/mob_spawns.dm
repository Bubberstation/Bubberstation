...
/obj/effect/mob_spawn/ghost_role/human/dauntless/prisoner
	...
	important_text = "You are not an antagonist. You are still bound to the Roleplay Rules regarding intent and esculation. Dauntless personnel can throw you into lava if you antagonize them."
