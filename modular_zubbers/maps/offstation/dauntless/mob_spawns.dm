...
/obj/effect/mob_spawn/ghost_role/human/dauntless/prisoner
	...
	important_text = "You are not an antagonist. You are still bound to the Roleplay Role 4. Dauntless personnel can throw you into lava if you antagonize them"
