...
/datum/map_template/ruin/lavaland/bubberstation/dauntless
	name = "SSV Dauntless"
	id = "lava-ship"
	description = "Highly secrative syndicate spy vessel hidden behind rolling storms of ash. It's assigned to observe NanoTrasen activities after the destruction of DS-2"
